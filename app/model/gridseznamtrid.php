...
class SeznamTrid extends Grid{
    ...
    protected function configure($presenter)
    {
        ...
        $source = new \NiftyGrid\DataSource\NDataSource($this->tridy->select('id_tridy,jmeno_tridy,zkratka_tridy,barva_ramu'));
...
//Předáme zdroj
       ...
       $this->addColumn('zkratka_tridy', 'Zkratka třídy', '')
          ...
          ->setRenderer(function($row) use($self){
           ...
           $this->addColumn('barva_ramu', 'Barva rámu', '')
              ...
              ->setRenderer(function($row) use($self){
                    ...
                    return \Nette\Utils\Html::el('input')->setText('')->addAttributes(array('type' => 'text' ,'disabled'=>'disabled','style' =>'width:50px;background:'.$row['barva_ramu'].'')); 
