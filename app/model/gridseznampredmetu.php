...
class SeznamPredmetu extends Grid{
    ...
    protected function configure($presenter)
    {
        ...
        $source = new \NiftyGrid\DataSource\NDataSource($this->tridy->select('id_predmetu,zkratka_predmetu,nazev,barva_textu,barva_pozadi '));
...
//Předáme zdroj
       ...
       $this->addColumn('barva_textu', 'Barva textu', '')
              ...
              ->setRenderer(function($row) use($self){
                    ...
                    return \Nette\Utils\Html::el('input')->setText('')->addAttributes(array('type' => 'text' ,'disabled'=>'disabled','style' =>'width:50px;background:'.$row['barva_textu'].'')); 
      ...
      $this->addColumn('barva_pozadi', 'Barva pozadí', '')
              ...
              ->setRenderer(function($row) use($self){
                    ...
                    return \Nette\Utils\Html::el('input')->setText('')->addAttributes(array('type' => 'text' ,'disabled'=>'disabled','style' =>'width:50px;background:'.$row['barva_pozadi'].'')); 
