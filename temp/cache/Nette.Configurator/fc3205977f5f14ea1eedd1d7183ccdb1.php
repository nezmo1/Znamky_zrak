<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/config/config.neon 
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/config/config.local.neon 

/**
 * @property TematickyPlanRepository $TematickyPlanRepository
 * @property TematickyPlanService $TematickyPlanService
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'tematickyplanrepository' => array('TematickyPlanRepository'),
			'tematickyplanservice' => array('TematickyPlanService'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app',
			'wwwDir' => 'E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app/../temp',
		));
	}
	...
	/**
	 * @return TematickyPlanRepository
	 */
	public function createService__TematickyPlanRepository()
	{
		$service = new TematickyPlanRepository($this->getService('nette.database.default.context'));
		return $service;
	}


	/**
	 * @return TematickyPlanService
	 */
	public function createService__TematickyPlanService()
	{
		$service = new TematickyPlanService($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=znamky_zrak', 'root', '', array('lazy' => TRUE));
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('E:\\xampp2\\htdocs\\znamky_nette_zrak\\sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
