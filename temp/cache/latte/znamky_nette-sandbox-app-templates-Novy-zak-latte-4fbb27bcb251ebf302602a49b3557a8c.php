...
list($_b, $_g, $_l) = $template->initialize('6394463835', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb32ac5686c9_content')) { function _lb32ac5686c9_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
