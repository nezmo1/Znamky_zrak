<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Seznam/ucitel.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9899061796', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb8dfdb0313b_content')) { function _lb8dfdb0313b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
