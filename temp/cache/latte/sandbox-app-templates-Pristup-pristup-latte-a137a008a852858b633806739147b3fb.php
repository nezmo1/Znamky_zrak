<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Pristup/pristup.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5651376652', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1f827a60fe_content')) { function _lb1f827a60fe_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
