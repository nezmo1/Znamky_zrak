<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Znamka/vygenFormNovaZnamka.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7189934472', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf72f0b7952_content')) { function _lbf72f0b7952_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
