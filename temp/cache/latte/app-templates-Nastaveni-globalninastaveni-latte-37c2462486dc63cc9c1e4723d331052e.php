<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Nastaveni/globalninastaveni.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3204800965', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb5067f9631d_content')) { function _lb5067f9631d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="right_col" role="main">
         
            <div class="page-title">
              <div class="title_left">
                  <h3>Globální nastavení <small></small></h3>
              </div>
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["glNastaveni"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
