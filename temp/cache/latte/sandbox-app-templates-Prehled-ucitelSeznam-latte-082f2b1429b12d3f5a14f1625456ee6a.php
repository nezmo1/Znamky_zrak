<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Prehled/ucitelSeznam.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5410121281', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb038240c1df_content')) { function _lb038240c1df_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
