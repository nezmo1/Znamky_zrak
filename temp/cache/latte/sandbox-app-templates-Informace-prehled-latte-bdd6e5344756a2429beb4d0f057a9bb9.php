<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Informace/prehled.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7053502426', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb11a7d7536e_content')) { function _lb11a7d7536e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?> <!-- page content -->
