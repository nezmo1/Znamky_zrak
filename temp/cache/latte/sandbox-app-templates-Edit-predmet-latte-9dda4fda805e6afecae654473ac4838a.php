<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Edit/predmet.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8415854634', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb26b6293eab_content')) { function _lb26b6293eab_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php Nette\Bridges\FormsLatte\FormMacros::renderFormBegin($form = $_form = $_control["editPredmet"], array($form)) ;if ($form->ownErrors) { ?><ul class=error>
