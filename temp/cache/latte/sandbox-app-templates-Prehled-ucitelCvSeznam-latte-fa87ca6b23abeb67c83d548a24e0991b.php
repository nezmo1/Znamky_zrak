<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Prehled/ucitelCvSeznam.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8211031016', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb7dc0f4c2b2_content')) { function _lb7dc0f4c2b2_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
...
<?php $_l->tmp = $_control->getComponent("seznamCvZnamekDetailReditelGrid"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
