<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app/templates/Uvazek/uciteluvazek.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7779941575', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3e682dc288_content')) { function _lb3e682dc288_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><script>
...
// block jmeno
//
if (!function_exists($_b->blocks['jmeno'][] = '_lb6b9f0cf403_jmeno')) { function _lb6b9f0cf403_jmeno($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
