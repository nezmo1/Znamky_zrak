<?php
// source: E:\xampp2\htdocs\znamky_nette_zrak\sandbox\app\model\NiftyGrid/../../templates/grid.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5718835389', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block _
//
if (!function_exists($_b->blocks['_'][] = '_lb5db545498d__')) { function _lb5db545498d__($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl(false, FALSE)
